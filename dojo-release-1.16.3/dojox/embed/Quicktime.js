...
define("dojox/embed/Quicktime", ["dojo/_base/kernel", "dojo/_base/lang", "dojo/_base/sniff", "dojo/_base/window", "dojo/dom", "dojo/dom-construct", "dojo/domReady!"], function(_1, _2, _3, _4, _5, _6) {
    var _7, _8 = { major: 0, minor: 0, rev: 0 },
        _9, _a = { width: 320, height: 240, redirect: null },
        _b = "dojox-embed-quicktime-",
        _c = 0,
        _d = "This content requires the <a href=\"http://www.apple.com/quicktime/download/\" title=\"Download and install QuickTime.\">QuickTime plugin</a>.",
        _e = _1.getObject("dojox.embed", true);
    ...
    if (!_3("ie")) {
        var id = "-qt-version-test",
            o = _7({ testing: true, width: 4, height: 4 }),
            c = 10,
            top = "-1000px",
            _18 = "1px";
